...
const minWidthQuery = (pixels: number) =>
  `only screen and (min-width: ${pixels}px)`;
const maxWidthQuery = (pixels: number) =>
  `only screen and (max-width: ${pixels}px)`;
const minHeightQuery = (pixels: number) =>
  `only screen and (min-height: ${pixels}px)`;
const maxHeightQuery = (pixels: number) =>
  `only screen and (max-height: ${pixels}px)`;
